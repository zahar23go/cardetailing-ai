...
from app.models import Box, BoxService, Tenant, User, UserRole, Service, Car, Appointment, AppointmentStatus, DiscountRule, Expense, Photo, EntityType, WorkingHours, AppointmentHistory, Payment, LoyaltyTierConfig
